...
#' \describe{
#'   \item{1}{The raw EEMs samples}
#'   \item{2}{The blanks associated with the EEMs}
#'   \item{3}{The absorbance data associated with the EEMs samples}
#' }
"raw_eem"
...
#' A sample set of data that's been uploaded for testing functions
#'
#' @format a data frame with 8 rows and 12 columns:
#' \describe{
#'   \item{index}{The numeric order of entry (e.g. 1, 2, 3, 4, etc…)}
#'   \item{analysis_date}{The date the samples were run on instrument (not collected in the field)}
#'   \item{description}{A brief description of the sample collected 60-character max, used for plot titles}
...
#'   \item{DOC_mg_L}{DOC concentration in mg/L of the original sample (not the diluted sample)}
#'   \item{Notes}{Not required, but can be used to note abnormal sample or experimental conditions}
#'   \item{unique_ID}{A unique ID given to each sample based on the data identifier, integration time, and replicate number}
#' }
"meta_clean"

#' A set of processed eems data
#'
#' A sample set of data that's been processed and clean
#'
#' @format a list of length 2:
#' \describe{
#'   \item{1}{The processed EEMs data}
#'   \item{2}{The processed absorbance data}
#' }
"data_process"
