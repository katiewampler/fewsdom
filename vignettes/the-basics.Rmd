...
dir.create(paste(wd, "example", sep="")) #create example folder (we'll delete at the end)
#unlink(paste(wd, "example", sep=""), recursive = T)
file.copy(file.path(data, list.files(data)), paste(wd, "example", sep=""))  #move example files over
```
...
```
```{r pressure, echo=FALSE, fig.cap="The summary plot  from the example", out.width = '100%'}
